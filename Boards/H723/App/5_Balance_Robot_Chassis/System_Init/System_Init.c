...
void System_Init() {
    ...
    //零点初始化
    // BM_save_zeroPoint_User(&leg_motors.BM_P1010B_Leg[0],-1.53915798f);
    // BM_save_zeroPoint_User(&leg_motors.BM_P1010B_Leg[1],0.48186172f);
    // BM_save_zeroPoint_User(&leg_motors.BM_P1010B_Leg[2],-2.03187666f);
    // BM_save_zeroPoint_User(&leg_motors.BM_P1010B_Leg[3],0.254640818f);
